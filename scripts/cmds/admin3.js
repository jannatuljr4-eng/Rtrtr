  ...
  onChat: async function ({
    ...
    try {
      ...
      const admins = [
        {
          ...
          triggers: [
            ...
            "@দুঁষ্টুঁঁ ছে্ঁলে্ঁর্ঁ মিঁঁষ্টিঁঁ ক্ঁথা্ঁ",
            "রায়হান",
      ...
      const captions = [
        ...
        "👉আমার বস ♻️ রায়হান এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো https://www.facebook.com/dekhalena.manata.antara.cokhe🔰 ♪√বস ফ্রি হলে আসবে🧡😁😜🐒",
        ...
        "Mantion_না দিয়ে বস রায়হান এর সাথে সিরিয়াস প্রেম করতে চাইলে ইনবক্স https://www.facebook.com/dekhalena.manata.antara.cokhe",
