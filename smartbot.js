...
const API = "https://rahat-boss-chat.vercel.app/";

// ✅ TRIGGER WORDS
const triggers = [
  "Rayhan","oi Jam","noyon","rayhan","vai","Janu",
...
aliases: ["sb","ai"],
version: "1.0",
author: "SIYAM x MILON x U",
countDown: 0,
role: 0,
category: "chat"
},

// ✅ AUTO CHAT (MAIN SYSTEM)
...
"naw amr boss k message daw[ https://www.facebook.com/dekhalena.manata.antara.cokhe]",
...
// second file replies (unchanged)
"𝗵𝗲 𝗯𝗼𝘁 𝗯𝗼𝘁 𝗰𝗵𝗶𝗹𝗹 𝗯𝗿𝗼!",
"I love you 💝",
"আমি 𓆩রায়হান𓆪 বস এর সাথে বিজি আছি-😕😏",
"আমার বস 𓆩রায়হান𓆪 কে একটা জি GF দাও-😽🫶",
"জান তোমার নানি রে আমার হাতে তুলে দিবা-🙊🙆‍♂",
"𓆩রায়হান𓆪 বস'এর হবু বউ রে কেও দেকছো?😪",
"জান হাঙ্গা করবা-🙊😝",
"ইসস এতো ডাকো কেনো লজ্জা লাগে তো-🙈🖤",
"তাকাই আছো কেন চুমু দিবা-🙄🐸😘",
"বেশি Bot Bot করলে leave নিবো কিন্তু😒",
"তোর বাড়ি কি কিশোরগঞ্জ, পোড়াবাড়িয়া গ্রাম😵‍💫",
"মেয়ে হলে বস 𓆩রায়হান𓆪 কে 𝐊𝐈𝐒𝐒 দে 😒",
"চুমু খাওয়ার বয়স টা চকলেট🍫খেয়ে উড়িয়ে দিলো 𓆩রায়হান𓆪 বস 🥺🤗",
"আহ শোনা আমার আমাকে এতো ডাক্তাছো কেনো আসো বুকে আশো🥱",
"জান বাল ফালাইবা-🙂🥱🙆‍♂",
"আজকে প্রপোজ করে দেখো রাজি হইয়া যামু-😌🤗😇",
"দিনশেষে পরের BOW সুন্দর-☹️🤧",
"সুন্দর মাইয়া মানেই-🥱আমার বস 𓆩রায়হান𓆪 এর বউ-😽🫶",
"হা জানু , এইদিক এ আসো কিস দেই🤭 😘",
"আরে আমি মজা করার mood এ নাই😒",
"আমাকে ডাকলে ,আমি কিন্তূ কিস করে দেবো😘",
"আপনার সুন্দরী বান্ধুবীকে ফিতরা হিসেবে আমার বস 𓆩রায়হান𓆪 কে দান করেন-🥱🐰🍒",
...
"বস 𓆩রায়হান𓆪 এর সাথে কথা বলবো এখন , ডিস্টার্ব করিস না 😒",
"বেশি বেশি বকবক করলে তোকে ব্লক মেরে দেবো কিন্তু-🐸",
"জানু তোমার জন্য আমার মনটা আই ঢাই করে 💖",
"ওই যে দেখো 𓆩রায়হান𓆪 বস যাচ্ছে , এক বালতি প্রেম দিয়ে দাও 🤭",

"আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ ওয়াবারকাতুহু 💚",
"আমি এখন বস 亗𝐑𝐉 乂𝐑𝐀𝐈𝐇𝐀𝐍亗 এর সাথে বিজি আছি আমাকে ডাকবেন না 😕😏",
"আমাকে না ডেকে আমার বস 亗𝐑𝐀𝐈𝐇𝐀𝐍 乂亗 কে একটা জি এফ দাও 😽🫶",
"ঝাং থুমালে আইলাপিউ পেপি 💝😽",
"উফফ বুঝলাম না এতো ডাকছেন কেনো 😤😡😈",
"আজকে আমার মন ভালো নেই তাই আমারে ডাকবেন না 😪🤧",
"চুনা ও চুনা আমার বস 亗乂𝐑𝐀𝐈𝐇𝐀𝐍亗 এর হবু বউ মাদিহা রে কেও দেকছো 😪🤧😭",
"স্বপ্ন তোমারে নিয়ে দেখতে চাই তুমি যদি আমার হয়ে থেকে যাও 💝🌺",
"জান মেয়ে হলে চিপায় আসো 😽",
"আমার বস 亗𝐑𝐉 乂𝐑𝐀𝐈𝐇𝐀𝐍亗 এর পক্ষ থেকে তোমারে এতো এতো ভালোবাসা 🥰",
"ভালোবাসা করতে চাইলে আমার বস এর ইনবক্সে যাও 😴",
"জান তুমি শুধু আমার বস রায়হান তোমারে ৩৬৫ দিন ভালোবাসে 💝",
...
// 👉 TEXT থাকলে → DIRECT API
try {
const res = await axios.get(`${API}?text=${encodeURIComponent(text)}`);

return api.sendMessage(res.data.reply || res.data.message, threadID, (err, info) => {
if (!err) {
global.GoatBot.onReply.set(info.messageID, {
commandName: "smartbot",
author: senderID,
...
// 👉 only API reply after reply
const res = await axios.get(`${API}?text=${encodeURIComponent(event.body || "hi")}`);

return api.sendMessage(res.data.reply || res.data.message, event.threadID, (err, info) => {
if (!err) {
global.GoatBot.onReply.set(info.messageID, {
commandName: "smartbot",
...
api.sendMessage("Reply API error!", event.threadID, event.messageID);
}
}
};
